...
public:
    ...
    // Перегрузка оператора умножения матрицы на вещественное число
    ...
    // Перегрузка оператора умножения вещественного числа на матрицу
...
int main() {
    ...
    cout << "\nРезультат умножения матрицы на вещественное число:\n";
    result_multiply_scalar.print();

    Matrix2x2 result_scalar_multiply = x * matrix2;
    cout << "\nРезультат умножения вещественного числа на матрицу:\n";
